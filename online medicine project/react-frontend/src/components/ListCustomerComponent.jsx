...
class ListCustomerComponent extends Component {
    ...
    deleteCustomer(id){
       CustomerService.deleteCustomer(id).then( res => {
            this.setState({customer: this.state.customers.filter(customer => customer.id !== id)});
        });
    }
    viewCustomer(id){
    ...
    addCustomer(){
       ...
       return(
            <div>
                 <div style={{backgroundImage:"url(https://www.dubaistandard.com/wp-content/uploads/2017/03/medicine-tablets.jpg)",width:'100%',
    height:'700px',}}>
